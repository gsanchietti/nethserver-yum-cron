...
class YumCron extends \Nethgui\Controller\Collection\AbstractAction //implements \Nethgui\Component\DependencyConsumer
{
    ...
    public function initialize()
    {
     ...
     $this->declareParameter('checkOnly', $validation, array('configuration', 'yum-cron', 'checkOnly'));
    ...
    public function prepareView(\Nethgui\View\ViewInterface $view)
    {
        ...
        $view['checkOnlyDatasource'] = \Nethgui\Renderer\AbstractRenderer::hashToDatasource(array(
                 'no' => $view->translate('Automatic_Update'),
                 'yes' => $view->translate('Check_Only'),));
    }
